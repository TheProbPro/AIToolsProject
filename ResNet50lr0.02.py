...
def objective(trial):
    ...
    weight_decay= trial.suggest_loguniform('wd', 1e-6, 1e-1)
    ...
    # 4) quick train for a few epochs
    model.train()
...
def train_full(model, train_loader, test_loader, optimizer, criterion, num_epochs):
    best_accuracy = 0.0
...
def main():
    ...
    # 3) full training + plots
    print("Starting training...")
    train_full(model, train_loader, test_loader, optimizer, criterion, num_epochs=200)
